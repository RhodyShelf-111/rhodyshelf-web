    ...
    <PageContainer className="max-w-5xl py-6 md:py-8">
      ...
      {brandListings.length > 0 && (
        <section className="mt-12">
          ...
          <div className="flex gap-3 sm:gap-4 overflow-x-auto scrollbar-subtle snap-x scroll-px-4 sm:scroll-px-6 lg:scroll-px-8 [--scrollbar-inset:1rem] sm:[--scrollbar-inset:1.5rem] lg:[--scrollbar-inset:2rem] -mx-4 px-4 sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8 pb-2 items-stretch">
            {brandListings.map((l) => (
              <div
                key={l.id}
